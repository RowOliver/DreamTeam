...
function startingHTML() {
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark mb-5">
            <span class="navbar-brand mb-0 h1 w-100 text-center">Generated Team</span>
        </nav>
        <div class="container">
            <div class="row">`;
        fs.writeFile("./Develop/templates/newmain.html", html, function(err) {
            if (err) {
                console.log(err);
            }
        });
...
function addHtml(member) {
    return new Promise(function(resolve, reject) {
        ...
        if (role === "Engineer") {
            ...
            <h5 class="card-header fab fa-etsy">${name}<br /><br />Engineer</h5>
            ...
            data = `<div class="col-6">
            <div class="card mx-auto mb-3" style="width: 18rem">
            <h5 class="card-header fab fa-monero">${name}<br /><br />Intern</h5>
            <ul class="list-group list-group-flush fab fa-invision">
                <li class="list-group-item">ID: ${id}</li>
                <li class="list-group-item">Email Address: ${email}</li>
